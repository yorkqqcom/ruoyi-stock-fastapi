    ...
    async showAIAnalysis() {
      ...
      try {
        ...
        const response = await postChat({
          query: `${this.lastSymbol}的个股分析：
1. 近期财务数据分析
请分析公司近3年营业收入、净利润、毛利率、净利率的变化趋势
计算并解读关键财务比率：ROE、EPS、资产负债率、流动比率、速动比率
对比同行业公司：收入增速是否高于行业平均？利润率处于什么分位？
关注异常波动项：是否存在非经常性损益对净利润的显著影响？
2. 主营业务深度分析
核心产品/服务的市场占有率及行业排名
主营业务收入构成：按产品/地区/客户分类的贡献比例
研发投入占比及专利储备情况（科技型企业重点）
客户集中度风险：前五大客户销售额占比是否超过30%？
供应链稳定性：原材料成本占比及供应商集中度
3. 资产负债表诊断
资产结构：流动资产/固定资产比例是否健康？现金及等价物是否覆盖短期负债？
负债端分析：有息负债规模及利率水平，关注短期借款与长期债务的匹配性
商誉占比：超过净资产的20%需警惕减值风险
存货周转率：对比历史数据与行业均值，是否存在滞销风险？
应收账款账龄结构：一年以上应收款占比是否异常升高？
4. 现金流质量验证
经营性现金流净额是否持续大于净利润？
投资现金流方向：资本支出主要用于产能扩张还是维持运营？
筹资活动分析：近年是否有频繁股权融资？分红政策是否稳定？
5. 成长性与风险评估
预测未来3年营收复合增长率（CAGR）的核心驱动因素
PEG估值：结合盈利增速判断当前PE是否合理
潜在风险提示：政策影响/技术替代/债务违约可能性
管理层能力评估：战略执行记录与行业经验
6. 综合估值框架
应用DCF模型时需重点关注的自由现金流预测假设
相对估值法：对比PE/PB/PS等指标的历史分位值与行业对比
安全边际测算：当前股价相比内在价值的折溢价空间`
        })
